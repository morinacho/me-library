...
###ver editorial 
		public function createModel(){
			try{
				$query = ConexionModel::conect()->prepare("SELECT nombre, id_editorial 
														   FROM editorial 
														   ORDER BY nombre");			 
		        $query->execute();
		...
		public function storeModel($request){
			try{
				$query = ConexionModel::conect()->prepare("INSERT INTO editorial (nombre, direccion_fiscal) 
														   VALUES (:nombre, :direccion_fiscal)");
